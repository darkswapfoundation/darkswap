...
/**
 * SIMD-enabled DarkSwap demo component
 */
const SimdDarkSwapDemo: React.FC = () => {
  // DarkSwap client
  const [client, setClient] = useState<SimdDarkSwapClient | null>(null);
  // Loading state
  ...
  useEffect(() => {
    const initClient = async () => {
      try {
        ...
        const darkswapClient = new SimdDarkSwapClient();
        ...
        setSimdSupported(darkswapClient.isSimdSupported());
  ...
  return (
    <div className="darkswap-demo">
      ...
      <div className="streaming-status">
        <h2>SIMD Status</h2>
        <p>
          SIMD instructions are {simdSupported ? 'supported' : 'not supported'} in your browser.
          {!simdSupported && ' Falling back to regular WebAssembly.'}
        </p>
      </div>
...
export default SimdDarkSwapDemo;