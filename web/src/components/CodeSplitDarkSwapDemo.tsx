...
/**
 * Code Split DarkSwap demo component
 */
const CodeSplitDarkSwapDemo: React.FC = () => {
  // DarkSwap client
  const [client, setClient] = useState<CodeSplitDarkSwapClient | null>(null);
  // Loading state
  ...
  useEffect(() => {
    const initClient = async () => {
      try {
        ...
        const darkswapClient = new CodeSplitDarkSwapClient('/darkswap-wasm', chunkCount);
   ...
   */
  const handleChunkCountChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="darkswap-demo">
      ...
      <div className="code-split-config">
        <h2>Code Split Configuration</h2>
        <div className="config-form">
          <div>
            <label htmlFor="chunkCount">Number of Chunks:</label>
            <input
              type="number"
              id="chunkCount"
              name="chunkCount"
...
export default CodeSplitDarkSwapDemo;