...
pub fn create_transport(
    keypair: &Keypair,
) -> Result<Boxed<(PeerId, libp2p::core::muxing::StreamMuxerBox)>, Box<dyn std::error::Error>> {
    // Create a TCP transport
    let tcp_transport = libp2p::tcp::TcpTransport::new(libp2p::tcp::GenTcpConfig::new().nodelay(true));
